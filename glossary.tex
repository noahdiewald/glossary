...
\newglossaryentry{2:l}{type=ling, name={2.\lx{sg}}, description={Second Person Singular: The suffix \wf{-bi} or the stem \wf{bi-} for the short pronominal form \wf{bitõ}.}}
...
\newglossaryentry{q:l}{type=ling, name={\lx{q}}, description={Question marker: The suffix \wf{-do} occurs on question words.}}
