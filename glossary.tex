...
\newglossaryentry{dem:l}{type=ling, name={\lx{dem}}, description={Demonstrative: The longer form \wf{bãdĩ} is generally provided as the translation for the Spanish proximal demonstrative, while the form \wf{ĩ} is provided for the distal in many cases.
    \citet{Peeke} also considered \wf{bãdĩ} to be proximal. There are significant instances of speakers translating the demonstratives in the opposite direction.
...
\newglossaryentry{3.sent:l}{type=ling, name={3.\lx{sent}}, description={* Third Person Singular Sentient: The suffix \wf{-kã} is used for sentient persons, such as people and some animals.
    The semantic distinction appears to be very similar to when an English speaker would choose \wf{he} or \wf{she} instead of \wf{it}.
    The suffix is also used as the lexical suffix for \gl{body}.}}

%% Lexical Suffix Labels

\newglossaryentry{body:l}{type=ling, name={.body}, description={* The lexical suffix \wf{-kã}. The suffix is also used as the third person singular sentient.}}
